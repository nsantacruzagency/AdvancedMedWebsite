  ...
  return (
    <div className="bg-white">
      ...
      <BeforeAfter
        ...
        items={[
          { label: 'Double Chin — 8 Weeks', result: 'Visible double chin reduction and improved jawline definition following 2 Cryo Contour sessions with RF tightening.', beforeSrc: '/images/before-after/double-chin-8-weeks/before.jpg', afterSrc: '/images/before-after/double-chin-8-weeks/after.jpg', beforeAlt: 'Before double chin treatment', afterAlt: 'After double chin treatment' },
