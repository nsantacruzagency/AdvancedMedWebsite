                      ...
                      {s.highlights && (
                        <ul className="mt-4 space-y-2 text-left">
                          {s.highlights.map((h, k) => (
                            <li key={k} className="flex items-center gap-2 text-sm font-medium text-espresso">
                              <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: '#d9542c' }} />
                              {h}
                            </li>
                          ))}
                        </ul>
