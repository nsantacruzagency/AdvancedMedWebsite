      ...
      <section className="bg-espresso py-16 px-5 sm:px-8 lg:px-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative w-full h-[320px] lg:h-[360px]">
            ...
            <div className="absolute top-20 left-[46%] w-[68%] h-[92%] overflow-hidden shadow-xl z-10">
              <img
              ...
              <div key={t.name} className="border border-cream-300 p-9">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div>
                      <p className="text-[8px] font-bold tracking-wide text-espresso-600 leading-none">Google</p>
                      <p className="text-[7px] text-espresso-400 leading-none mt-0.5">Verified Review</p>
                    </div>
                  </div>
                </div>
